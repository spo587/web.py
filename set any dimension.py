...
def fourdmastercardlist():
    ...
    for i in range(3):
            for j in range(3):
                for t in range(3):
                    for n in range(3):
                        fourdmastercardtuple+=[card((i,j,t,n)),]
...
dimensionlist=[twodmastercardlist(),threedmastercardlist(),fourdmastercardlist()]
...
class board(object):
    def __init__(self,cardsonboard,cardsremoved,dimension,dimensionlist=dimensionlist):
...
def randomdealdeadboards(numcards,numtrials,dimension,dimensionlist):
...
def playgame(dimension,dimensionlist,detectiontype):
    '''function to play a game with cards of specified dimension and detection type
    dimension=int
    dimensionlist=global list of mastercardlists
    ...
    numsets=0
    deadboards=0
    board1=board([],[],dimension,dimensionlist)
...
def deadboards(numgames,detectiontype):
    ...
    for i in range(numgames):
        listofdeadboards.append(playgame(4,dimensionlist,detectiontype))
